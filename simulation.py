...
class MAIN:
    ...
    def main_menu(self):
        ...
        while True:
            ...
            self.play_button = Button(WİDTH/2,(HEIGHT/2)-90,150,80,"Start",(125,50,89),text_color=(250,250,250))
...
class Button:
    def __init__(self,x,y,WİDTH,HEIGHT,text="text",bg_color=(255,255,255),text_color=(255,255,255)):
        #set button background
        self.rect= pygame.Rect(x,y,WİDTH,HEIGHT)
